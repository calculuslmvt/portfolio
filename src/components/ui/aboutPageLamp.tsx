      ...
      <LampContainer>
        ...
        >
            <div>
                ...
                <br/>
                <TextGenerateEffectDemo content = "In a world of endless digital food, the self grows hungry, adrift in a sea of information that provides no true nourishment. " textSize="text-xl dark:text-slate-300 text-black"/>
                <TextGenerateEffectDemo content = "The more we're connected, the more we feel alone - our devices amplifying the silence within." textSize="text-xl dark:text-slate-300 text-black"/>
